package pjserrano.stockcontrol.controller;
...
import pjserrano.stockcontrol.service.IProductService;
...
public class ProductController {
    ...
    @GetMapping(value = "/products/by-category", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
